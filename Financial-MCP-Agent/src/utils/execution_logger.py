...
class ExecutionLogger:
    ...
    def log_react_trajectory(self, agent_name: str, messages: List[Dict[str, Any]]):
        """Persist the complete observable ReAct AI/tool message trajectory."""
        ...
        self._save_json(
            payload,
            f"llm_interactions/{agent_name}_react_trajectory_{trajectory_id}.json",
        )
        return payload
