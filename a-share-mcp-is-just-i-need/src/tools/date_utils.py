...
from src.tools.contracts import MarketPeriod, ToolExecutionError, contract_tool
    ...
    def get_latest_trading_date() -> str:
        ...
        try:
            ...
            raise ToolExecutionError(
                ...
                "Could not determine the latest trading date.",
                retryable=True,
                details={"exception_type": type(e).__name__},
            ) from e

    @contract_tool(app)
    def get_market_analysis_timeframe(period: MarketPeriod = "recent") -> str:
        """
