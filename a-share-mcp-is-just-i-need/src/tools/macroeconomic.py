...
def register_macroeconomic_tools(app: FastMCP, active_data_source: FinancialDataSource):
    ...
    def get_required_reserve_ratio_data(
        start_date: OptionalISODate = None,
        end_date: OptionalISODate = None,
        year_type: ReserveRatioYearType = '0',
    ) -> str:
        """
        获取指定日期范围内的存款准备金率数据
        ...
        if year_type not in ['0', '1']:
            ...
            raise ToolExecutionError(
                ...
                details={"field": "year_type", "allowed": ["0", "1"]},
            )
    ...
    def get_money_supply_data_month(
        start_date: OptionalYearMonth = None,
        end_date: OptionalYearMonth = None,
    ) -> str:
        """
    ...
    def get_money_supply_data_year(
        start_date: OptionalYear = None,
        end_date: OptionalYear = None,
    ) -> str:
        """
